...
void State_MainMenu::OnCreate() 
{
	...
	_text.setPosition(_stateMgr->GetContext()->_wind->GetWindowSize().x / 2, _stateMgr->GetContext()->_wind->GetWindowSize().y / 2 - 100);

	_buttonSize = sf::Vector2f(300.0f, 32.0f);
	_buttonPos = sf::Vector2f(_stateMgr->GetContext()->_wind->GetWindowSize().x/2, _stateMgr->GetContext()->_wind->GetWindowSize().y / 2);
